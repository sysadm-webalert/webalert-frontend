               ...
               <div class="card panel shadow-sm">
                  ...
                  <div class="card-body">
                     <div class="web-image-container text-center mb-3 position-relative">
                        <img :src="site.snapshotUrl" class="img-fluid rounded" style="cursor: pointer;" @click="openImage(site.snapshotUrl)" @error="setFallbackImage($event, site.snapshotUrl)" alt="Site snapshot"/>
